...
const Testimonials = (props) => {
    ...
    function leftShiftHandler() {
        //agar neagtive me jane se less than zero[index] ho gaye toh gum ke last wale element pe chala jayega 
        if (index - 1 < 0) {
    ...
    function surpiseHandler() {
        //math.random se ek random no. milega 0 to 1 ke beech me
